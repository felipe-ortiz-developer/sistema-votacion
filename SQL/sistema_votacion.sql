...
-- Tiempo de generación: 11-04-2023 a las 20:23:13
...
CREATE TABLE IF NOT EXISTS `voto` (
  ...
  `ref_web` tinyint(1) NOT NULL,
  `ref_tv` tinyint(1) NOT NULL,
  `ref_redes_sociales` tinyint(1) NOT NULL,
  `ref_amigo` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
...
--
ALTER TABLE `comuna`
  ADD CONSTRAINT `comuna_ibfk_1` FOREIGN KEY (`region_id`) REFERENCES `region` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Filtros para la tabla `voto`
--
ALTER TABLE `voto`
  ADD CONSTRAINT `voto_ibfk_1` FOREIGN KEY (`candidato_id`) REFERENCES `candidato` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `voto_ibfk_2` FOREIGN KEY (`comuna_id`) REFERENCES `comuna` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
